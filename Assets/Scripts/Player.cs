...
public class Player : Paddle
{
        ...
        Dictionary<string, AudioSource> audioSourceMap = new Dictionary<string, AudioSource>
    {
        ...
        { "Stretch", soundEffectExpandPaddle },
        { "Fast Ball", soundEffectLightningBall },
        { "Split Ball", soundEffectSplitBall },
        { "Shrink", soundEffectShrinkPaddle },
        { "Curve Ball", soundEffectCurveBall },
        { "ZigZag Ball", soundEffectZigZagBall },
        { "Homing Ball", soundEffectHomingBall },
        { "InvisiBall", soundEffectInvisiBall },
        { "Wall Trap", soundEffectHorizontalWallTrap },
